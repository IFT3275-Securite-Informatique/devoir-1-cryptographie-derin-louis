...
#bicaracteres = [item for item, _ in Counter(cut_string_into_pairs(text)).most_common(256-len(caracteres))]

# Exemple

# Pour utiliser avec des autres cles il faut commenter les listes ci-dessous et decommenter celles ci-dessus
...
print(decrypt("110101010110110001110100110011110000111001101100110011111100110000001101"))